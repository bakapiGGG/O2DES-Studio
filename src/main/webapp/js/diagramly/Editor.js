...
(function()
{
	...
	// Editor.logoImage = IMAGE_PATH + '/O2DES.png';
	Editor.logoImage = IMAGE_PATH + '/O2DES_Studio_Logo_Icon_Dark.png';
	...
	Editor.prototype.setGraphXml = function(node)
	{
		...
		if (node != null)
		{
			...
			else if (node.nodeName == 'mxGraphModel')
			{
				...
				// By forcing mathEnabled equals true, we can always enabled the math support
				this.graph.mathEnabled = true;
	...
	if (window.StyleFormatPanel != null)
	{
		 ...
		 */
		// Here lists the available colour schemas for the fill and stroke of the shapes
		// Commeting out StyleFormatPanel.prototype.defaultColorSchemes will make the default colour schemes unavailable
		// StyleFormatPanel.prototype.defaultColorSchemes = 
		// [
		// 	[{fill: '', stroke: ''}, {fill: '#f5f5f5', stroke: '#666666', font: '#333333'},
